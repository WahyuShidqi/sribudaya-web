...
const Booking = () => {
  ...
  return (
    <section id="booking" className="m-0 p-0  w-full smooth-scroll">
      ...
      <div className="wedding-container py-16 px-5 md:px-12 lg:px-24 ">
        ...
        <LazyDiv>
          <div className="mb-8 w-fit animate-fade-right">
            <p className="page-title-desc">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo
              quidem quam est, exercitationem beatae, modi sequi porro quibusdam
              debitis, minima veniam temporibus molestias similique quae impedit
              et minus ipsa mollitia!
            </p>
          </div>
        </LazyDiv>
