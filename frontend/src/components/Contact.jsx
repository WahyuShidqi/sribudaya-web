      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="text-center mb-10 mt-12">
          ...
          <p className="text-lg md:text-xl text-white-700">
            Kami siap menyambut Anda di Sribudaya Resto & Homestay. <br /> Silakan hubungi kami melalui informasi berikut.
          </p>
        </div>
            ...
            <ul className="space-y-6 text-lg">
              <li className="flex items-center space-x-4">
                ...
                <span className='font-semibold'>
                  Alamat: <br />
                  <span className="font-normal">Jl. Soekarno Hatta, Lampeuneurut Ujong Blang, Darul Imarah, Aceh Besar.</span>
                </span>
              </li>
              <li className="flex items-center space-x-4">
                <span className="text-2xl "><FontAwesomeIcon icon="fa-solid fa-phone"/></span>
                <span className='font-semibold'>Telepon: <span className="font-normal">082267878880</span></span>
              </li>
              <li className="flex items-center space-x-4">
                <span className="text-3xl "><FontAwesomeIcon icon="fa-brands fa-whatsapp"/></span>
                <span className='font-semibold'>
                  WhatsApp:{' '}
                  <a
              ...
              <li className="flex items-center space-x-4">
                <span className="text-3xl "><FontAwesomeIcon icon="fa-brands fa-instagram"/></span>
                <span className='font-semibold'>
                  Instagram:{' '}
                  <a
              ...
              <li className="flex items-center space-x-4">
                <span className="text-3xl "><FontAwesomeIcon icon="fa-brands fa-tiktok"/></span>
                <span className='font-semibold'>
                  TikTok:{' '}
                  <a
